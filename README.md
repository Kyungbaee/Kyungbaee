...
<div>
  ...
  <table style="border-collapse: collapse;">
    ...
    <tr>
      ...
      <td style="padding: 5px;">Game & AI Systems Programmer</td>
    </tr>
    <tr>
  ...
  <h3>🧭 About Me</h3>
  <p>
    게임 개발을 기반으로, 현재는 <strong>AI 에이전트와 실시간 상호작용 시스템</strong>에 관심을 두고 있습니다.<br>
    Unreal Engine과 Unity를 활용해 <strong>게임 클라이언트 구조</strong>를 다루는 동시에,  
    Python과 C++을 이용한 <strong>AI 모델 연동 및 백엔드 개발</strong>에도 도전하고 있습니다.<br><br>
    플레이어와 AI가 함께 만들어가는 <strong>인터랙티브 환경</strong>에 매력을 느끼며,  
    "게임적 사고를 가진 개발자"로 성장하기 위해 꾸준히 연구하고 있습니다.
  </p>
  ...
  <ul>
    ...
    <li>Python (AI Integration / Backend) — Basic</li>
  ...
  <ul align="left">
    <li><strong>Baekjoon MCP – AI 모델 간 맥락 공유 프로토콜 구현 (2025.10 ~ ing)</li>
  </ul>

  </br>

  <h3>🏗️ Completed Projects</h3>
  <ul align="left">
    <li><strong>Forever Planet</strong> – Globe View 기반 2.5D RPG 개발 (2025.04 ~ 2025.05)</li>
    <li><strong>Unnamed Project</strong> – 3D 액션 오픈월드 RPG 개발 (2024.12 ~ 2025.02)</li>
    <li><strong>SynchroYOU</strong> – AI 기반 실시간 댄스 점수 분석 서비스 (2024.10 ~ 2024.11)</li>
  </ul>
</div>
